document.addEventListener('DOMContentLoaded', function () {
    ...
    // ==========================================
    // Слухаємо глобальну подію з diploma.js замість власного fetch-запиту!
    document.addEventListener('data:updated', function(e) {
        ...
        // 3. Оновлення Температури, Вологості та кількості Тривог вже обробляється у diploma.js!
        // Ми лише доопрацюємо специфічні бейджі
        ...
        // 4. Оновлення специфічного графіка "Показники Середовища"
